...
<!-- ### BARRA TITULOS ### -->
<section class="barra-titulo bg-cor-gestao">
    <section class="container text-center flex space-between align-items-center">
        ...
        <h1 class="fonte-cor-branca fonte-40">Gestão</h1>
...
<section class="barra-submenus">
    <section class="container">
        <nav class="flex space-evenly">
            <a class="fonte-cor-gestao-hover active" href="#">Todas as Notícias</a>
            <a class="fonte-cor-gestao-hover" href="#">Expansão</a>
            <a class="fonte-cor-gestao-hover" href="#">Responsabilidade</a>
            <a class="fonte-cor-gestao-hover" href="#">Economia</a>
            <a class="fonte-cor-gestao-hover" href="#">Mercado</a>
        </nav>
    </section>
</section>
    ...
    <section class="container flex flex-wrap gap-32">
       <?php for ($i=0; $i < 8; $i++): ?> 
            <section class="card flex flex-column align-items-start gap-8">
                ...
                <span class="tag gestao">Responsabilidade</span>
                <a class="fonte-bold fonte-cor-gestao-hover" href="#">Nestlé Brasil assina contrato para aquisição do Grupo CRM, dono da Kopenhagen</a>
            </section>
       <?php endfor ?>
    </section>
    ...
    <section class="container flex flex-wrap gap-32">
       <?php for ($i=0; $i < 8; $i++): ?> 
            <section class="card flex flex-column align-items-start gap-8">
                ...
                <span class="tag gestao">Mercado</span>
                <a class="fonte-bold fonte-cor-gestao-hover" href="#">Nestlé Brasil assina contrato para aquisição do Grupo CRM, dono da Kopenhagen</a>
            </section>
       <?php endfor ?>
    </section>
...
<section class="paginacao">
   <section class="container">
        <ul class="flex content-center gap-8">
            <li><a class="bg-cor-gestao fonte-cor-branca" href="#">1</a></li>
